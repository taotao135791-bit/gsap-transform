...
**Related skills:** For single tweens and eases use **gsap-core**; for scroll-driven timelines use **gsap-scrolltrigger**; for React use **gsap-react**. For aesthetic direction and motion language use the design-layer skills: **motion-design-taste**, **motion-recipes**, **motion-anti-slop**, **motion-craft**.
