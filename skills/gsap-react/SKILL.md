...
**Related skills:** For tweens and timelines use **gsap-core** and **gsap-timeline**; for scroll-based animation use **gsap-scrolltrigger**; for Vue/Svelte or other frameworks use **gsap-frameworks**. For aesthetic direction, recipes, and anti-slop checks use the design-layer skills: **motion-design-taste**, **motion-recipes**, **motion-anti-slop**, **motion-craft**.
